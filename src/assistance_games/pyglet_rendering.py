"""
2D pyglet-based rendering framework, mostly copied from Gym 0.21.0.
"""
import os
import sys
...
try:
    from pyglet.canvas import Display, get_display as pyglet_get_display
    from pyglet.image import get_buffer_manager, load as image_load
    import pyglet
